        ...
        <nav className="flex items-center space-x-8">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 mt-3 w-56 bg-white border border-gray-100 rounded-2xl shadow-2xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[60]">
              ...
              <a href="/login" className="flex items-center space-x-3 px-4 py-3 text-sm font-semibold text-gray-700 hover:bg-pink-50 hover:text-[#D10043] transition-colors">
                <LogIn size={18} className="text-gray-400" />
                <span>Login here</span>
              </a>
              <a href="#" className="flex items-center space-x-3 px-4 py-3 text-sm font-semibold text-gray-700 hover:bg-pink-50 hover:text-[#D10043] transition-colors">
