...
const ApplicationTrends = () => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-[32px] p-6 sm:p-8 lg:p-10 shadow-sm mb-8">
      <div className="flex justify-between items-start mb-8">
        <div>
          <h3 className="text-lg md:text-xl font-extrabold tracking-tight text-gray-900">Application Trends</h3>
      ...
      <div className="overflow-x-auto scrollbar-hide pb-12 -mx-2 px-2">
        <div className="min-w-[600px] h-[280px] relative border-b-2 border-l-2 border-gray-100 mt-6 pl-4 pb-2">
          ...
          <div className="w-full h-full flex items-end justify-between px-6 relative z-10">
          ...
          <div className="absolute -bottom-8 left-0 pl-4 w-full flex justify-between text-[11px] text-gray-500 font-bold px-6 tracking-wide">
            {chartData.map((data, index) => (
