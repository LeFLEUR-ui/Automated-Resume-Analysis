      ...
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
            ...
            {navItems.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl flex items-center space-x-2.5 transition-all duration-300 group ${
                    isActive 
        ...
        <div className="flex items-center space-x-4 relative shrink-0" ref={dropdownRef}>
            ...
            <div className="absolute right-0 top-[calc(100%+16px)] w-72 bg-white border border-gray-100 rounded-[24px] shadow-2xl py-3 z-[60] animate-in fade-in slide-in-from-top-4 duration-200">
              ...
              <button onClick={() => navigate(isAdmin ? '/admin/settings' : '/candidate/profile')} className="w-full text-left px-6 py-3.5 text-sm font-bold text-gray-600 hover:bg-gray-50 hover:text-gray-900 flex items-center space-x-4 transition-all group">
        ...
        <div className="lg:hidden absolute top-[100%] left-0 w-full bg-white border-b border-gray-100 shadow-2xl py-4 px-6 space-y-2 z-[100] animate-in slide-in-from-top-2 duration-300">
          ...
          <div className="pt-4 mt-4 border-t border-gray-100">
            {isApplicationPage ? (
              ...
              <>
                <button onClick={() => navigate(isAdmin ? '/admin/settings' : '/candidate/profile')} className="w-full flex items-center space-x-4 p-4 text-gray-700 font-bold transition-all hover:bg-gray-50 rounded-xl mb-1">
